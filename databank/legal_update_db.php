...
$sql = "UPDATE legaldata SET Status = '$Status',Follow_Up_By = '$Follow_By',Entry_Date = '$Entry_Date',Date_Applied = '$Date_Applied',Customer = '$Customer',Place = '$Place',Website_Registration = '$Website_ragiter',Certificate_No = '$Certificate_No',Vendor_Code = '$Vendor_Code',Validity_Date = '$Validity_Date',Remarks = '$Remarks' WHERE Sr_no = '$vender_id'";
