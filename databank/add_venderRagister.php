...
if(isset($_POST['submit'])){
	  ...
	  $sqlx="SELECT MAX(Sr_no) as id FROM Data";
	...
	$sql = "INSERT INTO Data (Sr_no,Status,Follow_Up_By,Entry_Date,Date_Applied,Customer,Place,Website_Registration,Certificate_No,Vendor_Code,Validity_Date,Remarks) VALUES ('$vender_id','$Status','$Follow_By','$Entry_Date','$Date_Applied','$Customer','$Place','$Website_ragiter','$Certificate_No','$Vendor_Code', " . ($Validity_Date == NULL ? "NULL" : "'$Validity_Date '") . ",'$Remarks') ";
