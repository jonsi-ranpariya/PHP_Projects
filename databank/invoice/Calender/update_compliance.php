...
{ 
  ...
  $sql = "SELECT Sr_no,Compliance,Category,Due_Date,Company_Due_Date,Status,format(Filed_Date, 'dd-MMM-y') as Filed_Date,Filed_Date as fdate,Prepared_By,Reviewed_By from Compliance WHERE Sr_no = '".$_POST["id"]."'";
