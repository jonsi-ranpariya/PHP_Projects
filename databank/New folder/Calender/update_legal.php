...
{ 
  ...
  $sql = "SELECT Sr_no,Compliance,Category,Department,Due_Date,Company_Due_Date,Status,format(Filed_Date, 'dd-MMM-y') as Filed_Date,Filed_Date as fdate,Prepared_By,Reviewed_By from legal WHERE Sr_no = '".$_POST["id"]."'";
   ...
   $output .= '
    ...
    <div class="row">
     ...
     <div class="row">
         ...
         <input class="col-6" type="file" name="doc[]" multiple required>
    </div>

  <table><tr><td>
    ';
    $sql1 = "SELECT file_source from L_upload where iid = '".$_POST["id"]."'";    /*view upload file*/
    $run1 = sqlsrv_query($con,$sql1);
    while($row1 = sqlsrv_fetch_array($run1, SQLSRV_FETCH_ASSOC)){

        $output .= '
         <button type="button" class="btn btn-primary btn-floating luploadImg" id="'.$row1['file_source'].'" style="margin: 5px"><i class="fa fa-eye" aria-hidden="true"></i></button></i>
      ';
    }
    $output .= '
  </td></tr></table></div>
