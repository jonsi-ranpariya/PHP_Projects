...
{ 
  ...
  $sql = "SELECT * FROM issue WHERE emp_id = '$id' and flag = 0";
       ...
       <div class="col-lg-9" >
         ...
         <div class="table-responsive">
          <table id="editdata">
            ...
            $sqlq = "SELECT b.Sr_no,b.iid,b.Item,a.sr_no,a.qnty,a.emp_id,a.p_name,a.IP_Address,a.CUG_Number,a.U_name,a.password,a.dpnt,a.location,a.Make,a.Model,a.Serial_Number,a.Mac_Address,a.Screen_Size,a.RAM_1,a.RAM_2,a.HDD_1,a.HDD_2,a.HDD_3,a.OS,a.AntiVirus,a.Manf_Year FROM issue a inner join M_Item b on a.item_category = b.iid where a.emp_id = '$id' and flag = 0";
         ...
         $output .='
                    <tr>
                     ...
                     <td><select  name="make[]" class="form-control make1" >
                      ...
                      <td style="width:10%"><input type="text" name="model[]" value="'.$row['Model'].'" class="form-control modal11" id="mod1'.$abc.'"></td>
                      <td style="width:9%"><input type="text" step="0.01"  name="Sr_Number[]" value="'.$row['Serial_Number'].'" class="form-control Sr_Number1"  id="srnumber'.$abc.'" ></td>
                      <td><input type="text" name="Mac_Add[]" id="Mac_Add'.$abc.'" class="form-control Mac_Add1" value="'.$row['Mac_Address'].'" placeholder="Enter ..." ></td>
                      <td style="width:5%"><select  name="Scrn_Size[]" class="form-control Scrn_Size1" id="sSize'.$abc.'" >
                      ...
                      <td style="width:6%"><select  name="ram_1[]" class="form-control ram-11" id="ram1'.$abc.'" >
                      ...
                      <td style="width:6%"><select  name="ram_2[]" class="form-control ram-21" id="ram2'.$abc.'" >
                      ...
                      <td>
                        <select  name="hhd_1[]" class="form-control hhd-11" id="hhd1'.$abc.'" >
                      ...
                      <td style="width:6%"><select  name="hhd_2[]" class="form-control hhd-21" id="hhd2'.$abc.'" >
                      ...
                      <td><select  name="hhd_3[]" class="form-control  hhd-31" id="hhd3'.$abc.'" >
                      ...
                      <td>
                        <select name="os[]" class="form-control os1" id="operating'.$abc.'" >
                      ...
                      <td>
                        <select name="AntiVirus[]" class="form-control AntiVirus1" id="anti'.$abc.'" >
