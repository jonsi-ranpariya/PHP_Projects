...
if (isset($_POST['month'])) {
    ...
    ?>        
        <tr>
          ...
          <td><button type="button" class="btn px-3"  onclick="return popitup('upload/<?php echo $row['file_source'];?>')"><i class='fas fa-arrow-circle-down' style='font-size:36px'></i></button></td>
        </tr>    
      <?php   
      }
    ?>
