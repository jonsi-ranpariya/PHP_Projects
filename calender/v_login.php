...
<style type="text/css">
  body{
    background: url('login_image/6.jpg') no-repeat;
    width: 100% !important;
      ...
      <div class="col-md-4 col-sm-4 col-xs-12"></div>
       <div class="col-md-4 col-sm-4 col-xs-12">        <!-- login file db -->
         <form action="v_login_db.php" method="POST" id="log" accept-charset="utf-8" >
          <h1>LOGIN</h1>
          <img src="login_image/7.jpg" class="img img-responsive rounded-circle d-none d-lg-block">
             <div class="form-group">
                 <label>User Name</label>
                 <input type="text" name="u_name" class="form-control" placeholder="-- User --">
             </div><br>
             <div class="form-group">
            ...
            <button type="submit" name="login_btn" class="btn btn-warning py-2 px-5">Login</button>
         </form>
       </div>
       <div class="col-md-4 col-sm-4 col-xs-12"></div>
    </div>
